...
final class ModelListCommand extends Command
{
    ...
    {
        $this
            ->addOption('provider', 'p', InputOption::VALUE_REQUIRED, 'Filter by provider name (e.g. "Anthropic", "Amazon", "Meta")')
            ->addOption('output-modality', 'o', InputOption::VALUE_REQUIRED, 'Filter by output modality (e.g. "TEXT", "IMAGE", "EMBEDDING")')
            ->addOption('inference-type', 'i', InputOption::VALUE_REQUIRED, 'Filter by inference type (e.g. "ON_DEMAND", "PROVISIONED")')
        ;
    }
